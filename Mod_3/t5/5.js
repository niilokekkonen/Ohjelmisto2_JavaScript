...
picArray.forEach((pic,) => {
  ...
  parag.textContent = pic.description;

  //Article element
  section.appendChild(arElem);
  arElem.appendChild(h2Elem);
  arElem.appendChild(parag);

  //Appending to the figure element
  arElem.appendChild(fig);
